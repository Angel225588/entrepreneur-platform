...
export default function WhySuccessPage() {
  ...
  useEffect(() => {
    const storedPoints = localStorage.getItem('why-stage-points')
    ...
    currentProgress['start-with-why'] = {
      completed: true,
  ...
  const handleBackToStages = () => {
    ...
    localStorage.removeItem('why-chat-answers')
    localStorage.removeItem('why-chat-completed')
    localStorage.removeItem('why-stage-points')
