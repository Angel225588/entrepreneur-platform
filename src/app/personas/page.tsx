    ...
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <FeatureCard
          ...
          subtitle="Know Your Audience"
          description="We will find out who is your client, what are their needs, motivations and frustrations."
          benefits={[
            "Clear understanding of your target audience",
            "Detailed client needs and motivations",
            "Identification of pain points and frustrations",
            "Better product-market fit insights"
          ]}
          buttonText="Continue"
          centerIconText="USER"
          image="/images/stages/Personas.jpg"
          layout="vertical"
