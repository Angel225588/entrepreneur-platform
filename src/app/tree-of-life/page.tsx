  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <FeatureCard
          title="Tree of Life"
          subtitle="Explore Your Roots"
          description="This is about your values, motivations and to discover 'WHY' do you want to do this project, what will be the result of it, and how you'll do it."
          benefits={[
            "Clear vision of your project and the reason behind",
            "Clear steps to proceed with the project",
            "A deck with all your answers"
          ]}
