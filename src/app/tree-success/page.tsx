...
export default function TreeSuccessPage() {
  ...
  useEffect(() => {
    const storedPoints = localStorage.getItem('tree-stage-points')
  ...
  const handleBackToStages = () => {
    ...
    localStorage.removeItem('tree-chat-answers')
    localStorage.removeItem('tree-chat-completed')
    localStorage.removeItem('tree-stage-points')
